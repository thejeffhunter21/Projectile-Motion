...
function findWasmBinary() {
  return locateFile('projectile.wasm');
}
...
var _launch = Module['_launch'] = makeInvalidEarlyAccess('_launch');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['launch'] != 'undefined', 'missing Wasm export: launch');
  ...
  _launch = Module['_launch'] = createExportWrapper('launch', 3);
  _update = Module['_update'] = createExportWrapper('update', 1);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = ProjectileModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = ProjectileModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => ProjectileModule);
